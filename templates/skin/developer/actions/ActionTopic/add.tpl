...
<div class="profile-user">
	...
	<form action="" method="POST" enctype="multipart/form-data">
		...
		<input type="hidden" name="topic_cat" value="{$_aRequest.topic_cat}" />
		

		<script language="JavaScript" type="text/javascript">
			ajaxBlogInfo({$_aRequest.blog_id});
		</script>
		...
		{/if}
		<textarea name="topic_text" id="topic_text" rows="5" class="input-wide">{$_aRequest.topic_text}</textarea><br /><br />
