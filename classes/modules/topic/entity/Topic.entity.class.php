...
{    
	...
	public function getTopicCat() {
        return $this->_aData['topic_cat'];
    }
    
	public function getGuestVote() {
        return $this->_aData['guest_vote'];
    }
	public function getCoockieVote() {
		if (isset($_COOKIE["ref_vote_".$this->getId()]))
			return $_COOKIE["ref_vote_".$this->getId()];
		else
			return 0;
    }
	...
	public function getAnswerText() {
        return $this->_aData['topic_answer'];
    } 
	public function getAnswerData() {
        return $this->_aData['topic_answer_data'];
    } 
	public function getAnswerAutor() {
        return $this->_aData['topic_answer_autor'];
    } 
	...
	public function getAnswerAutorObj(){
	 if($oAnsAutor = $this->User_GetUserById($this->getAnswerAutor()))
	  return $oAnsAutor;
	 else
	  return false;
	}
	...
	public function setTopicCat($data) {
        $this->_aData['topic_cat']=$data;
    }
	public function setTopicGuestVote($data) {
        $this->_aData['guest_vote']=$data;
    }
	public function setCoockieVote($data) {
        setcookie("ref_vote_".$this->getId(), $data, time()+60*60*24*30,'/');
    }
	public function setAnswerText($data) {
        $this->_aData['topic_answer']=$data;
    }
	public function setAnswerData($data) {
        $this->_aData['topic_answer_data']=$data;
    }
	public function setAnswerAutor($data) {
        $this->_aData['topic_answer_autor']=$data;
    }
