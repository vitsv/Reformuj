 ...
 * Ustawienia wyglądu
 */
$config['view']['skin']        = 'developer';                                                              // szablon
$config['view']['name']        = 'Refarmator.pl - słuchaj swoih klienów';                   // nazwa strony
$config['view']['description'] = 'Refarmator.pl - słuchaj swoih klienów'; // seo description
$config['view']['keywords']    = 'sugestie, reformator, feedback';      // seo keywords
$config['view']['tinymce']          = false;  // używać TinyMCE
$config['view']['noindex']          = true;   // czy chować linki od wyszukiwarek rel="nofollow"
$config['view']['img_resize_width'] = 500;    // szyrokość do jakiego będzie zeskalowany obraz
$config['view']['img_max_width'] = 3000;    //maksymalna szyrokość obrazów które może załadować użytkownik
$config['view']['img_max_height'] = 3000;    // maksymalna wysokość
...
/**
 * Ustawienia sidebar'u
 */
$config['block']['stream']['row'] = 20;  // Ilość wpisów w "Na żywa"
$config['block']['blogs']['row']  = 50;  // Ilość wpisów w "Projekty"
/**
 * Ustawienie ściżek
 * Jeżeli należy zainstalować system nie do katalogu głownego, to należy zrobić następujoco:
 * $config['path']['root']['web']    = 'http://'.$_SERVER['HTTP_HOST'].'/subdir';
 * $config['path']['root']['server'] = $_SERVER['DOCUMENT_ROOT'].'/subdir';
 * prawdopodobnie trzeba będzie ziekszyć SYS_OFFSET_REQUEST_URL na liczbe podkatalogów, 
 * np. dla www.site.ru/reformator/ należy wpisać 1 
 */
$config['path']['root']['web']        = 'http://'.$_SERVER['HTTP_HOST'].'/ls';     // adres strony
$config['path']['root']['server']     = $_SERVER['DOCUMENT_ROOT'].'/ls';          // ścieżka do strony w systemie plików
/**
 ...
 * Языковые настройки
 */
$config['lang']['current'] = 'polish';                                                // текущий язык текстовок
...
$config['acl']['vote']['topic']['limit_time']             = 60*60*24*20*10; // ограничение времени голосования за топик
$config['acl']['vote']['comment']['limit_time']           = 60*60*24*5;  // ограничение времени голосования за комментарий
/**
 * Настройки модулей
 */
// Модуль Blog
$config['module']['blog']['per_page']        = 50;   // Число блогов на страницу
...
$config['module']['topic']['per_page']   = 50;          // Число топиков на одну страницу
 ...
 */
$config['db']['params']['host']   = 'db14.1and1.pl';
$config['db']['params']['port']   = '3306';
$config['db']['params']['user']   = 'dbo350993527';
$config['db']['params']['pass']   = 'livestreet';
$config['db']['params']['type']   = 'mysql';
$config['db']['params']['dbname'] = 'db350993527';
/**
...
$config['router']['page']['widget']         = 'ActionWidget';
